...
describe("probando función mdLinks", () => {
  ...
  it("deberia retornar el total de los links y los unique de una ruta de un Directorio", () => {
    ...
    mdLinks('./test/prueba.prueba.md',{validate:false, stats:true}).then(res =>
      expect(res).toEqual(
        { total: 1, unique: 1 }
      )
    );
  ...
  it("deberia retornar los links de una ruta de un archivo", () => {
    ...
    mdLinks('./test/prueba.prueba.md',{validate:false, stats:false}).then(res =>
      expect(res).toEqual(
        [
          {
            href: 'https://user-images.githubusercontent.com/110297/42118443-b7a5f1f0-7bc8-11e8-96ad-9cc5593715a6.jpg',
  ...
  it("deberia retornar valores de href,text,file,status,response de un directorio", () => {
    ...
    mdLinks('./test/prueba.prueba.md',{validate:true, stats:false}).then(res =>
      expect(res).toEqual(
        [
          {
            href: 'https://user-images.githubusercontent.com/110297/42118443-b7a5f1f0-7bc8-11e8-96ad-9cc5593715a6.jpg',
  ...
  it("deberia retornar los totales, unique y broken de un archivo ", () => {
    ...
    mdLinks('./test/prueba.prueba.md',{validate:true, stats:true}).then(res =>
      expect(res).toEqual(
        { total: 1, unique: 1, broken: 0 }
      )
    );
